...
tidy_female <- tidy_genepop("../00-data/25230snps_81ind.txt", strata="../00-data/population_map_palinurus_243ind_mpa.txt")
...
#### Download data for diplodus
tidy_male <- tidy_genepop("../00-data/25230snps-101ind.txt", strata="../00-data/population_map_palinurus_243ind_mpa.txt")
